                            ...
                            <div class="col-12">
                                <div class="card" style="border: none !important;">
                                    <div class="card-body">
                                        ...
                                        <a href="{{url('view-coursetitle')}}" class="btn btn-primary mb-2">View Course title</a>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="input-types-preview">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <form action="{{url('add-coursetitle')}}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                <select name="course_id" class="form-select" aria-label="Default select example">
                                                                    ...
                                                                    @foreach($getAllCourse as $getAllCourses)
                                                                    <option value="{{$getAllCourses->id}}">{{$getAllCourses->name}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
