                            ...
                            <div class="col-12">
                                <div class="card" style="border: none !important;">
                                    <div class="card-body">
                                        ...
                                        <a href="{{url('view-degrees')}}" class="btn btn-primary mb-2">View Degrees</a>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="input-types-preview">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <form action="{{url('add-degree')}}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="mb-3">
                                                                <label for="simpleinput" class="form-label">Degree Name</label>
                                                                <input type="text" name="name" id="simpleinput" class="form-control">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="example-fileinput" class="form-label">Degree Thumbnail</label>
