                                ...
                                <div class="card" style="border: none !important;">
                                    <div class="card-body">
                                        ...
                                        <table class="table table-dark">
                                            ...
                                            <tbody>
                                                @foreach($getAllSpecializtion as $getAllSpecializtions)

                                                <tr>
                                                    <td>{{$getAllSpecializtions->name}} </td>
                                                    <td><img src="{{ ('images/'.$getAllSpecializtions->image) }}" style="height: 100px;"></td>
                                                    <td>{{$getAllSpecializtions->name}} </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
