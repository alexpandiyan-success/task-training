        ...
        <section class="py-5 text-center container">
          <div class="row py-lg-5">
            <div class="col-lg-6 col-md-8 mx-auto">
              ...
              <a href="{{ url('add-course-learning') }}" class="btn btn-primary my-2">Add Course Learning</a>
              <!-- <a href="{{ url('course-learning-management-url-edit') }}" class="btn btn-secondary my-2">Update Course Learning</a> -->
              </p>
            </div>
          </div>
        </section>
