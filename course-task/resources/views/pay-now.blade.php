                ...
                <div class="col-lg-12 col-md-12 col-12 mt-n8 mb-4 mb-lg-0">
                    ...
                    <div class="tab-content" style="background-color: white;box-shadow: 0px 0px 10px 10px #ddd;">
                        ...
                        <div class="tab-pane show active" id="input-types-preview" style="padding: 20px;">
                            <h5 style="color: green;">{{$success ?? ''}} </h5><br>
                            <div class="row">
                                <div class="col-lg-12">



                                    <form action="{{url('add-pay-now')}}" method="POST">
                                        @csrf


                                        <div class="mb-3">
                                            <select name="enquiry_id" class="form-select" aria-label="Default select example">
                                                <option value="" hidden>Select Student</option>
                                                @foreach($getAllEnquiry as $enquiry)
                                                <option value="{{$enquiry->id}}">{{$enquiry->name}} - {{$enquiry->email}} - {{($enquiry['course_enquiry'])}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label for="simpleinput" class="form-label">Reference Number</label>
                                            <input type="text" name="reference_number" id="simpleinput" class="form-control">
                                        </div>
                                        <div class="mb-3">
