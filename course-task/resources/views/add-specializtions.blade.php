                            ...
                            <div class="col-12">
                                <div class="card" style="border: none !important;">
                                    <div class="card-body">
                                        ...
                                        <a href="{{url('view-specializtions')}}" class="btn btn-primary mb-2">View Specializtion</a>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="input-types-preview">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <form action="{{url('add-specializtions')}}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="mb-3">
                                                                <label for="simpleinput" class="form-label">Specializtion Name</label>
                                                                <input type="text" name="name" id="simpleinput" class="form-control">
                                                            </div>
                                                            <div class="mb-3">
                                                                <select name="degree_id" class="form-select" aria-label="Default select example">
                                                                    <option value="" hidden>Select Techlonology</option>
                                                                    @foreach($getDegreesSpa as $getDegree)
                                                                    <option value="{{$getDegree->id}}">{{$getDegree->name}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="example-fileinput" class="form-label">Specializtion Thumbnail</label>
