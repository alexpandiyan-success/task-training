    ...
    <div>
      <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
        <section class="py-5 text-center">
          <a href="{{url('view-rejectedenquiry')}}" class="btn btn-primary mb-2" style="float: right;"> Reject </a>
          ...
          <table class="table table-dark table-striped table-responsive">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$stu['name']}}</td>
                @endforeach
                <td><a href="{{url('reject/'.$allEnquiry['id'])}}" class="btn btn-primary mb-2"> Reject </a></td>
