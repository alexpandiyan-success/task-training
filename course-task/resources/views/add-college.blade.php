                            ...
                            <div class="col-12">
                                <div class="card" style="border: none !important;">
                                    <div class="card-body">
                                        ...
                                        <a href="{{url('view-colleges')}}" class="btn btn-primary mb-2">View Colleges</a>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="input-types-preview">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <form action="{{url('add-college')}}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="simpleinput" class="form-label">College Location</label>
                                                                <input type="text" name="location" id="simpleinput" class="form-control">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="example-fileinput" class="form-label">College Thumbnail</label>
